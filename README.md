...
Relational Databases create relations between tables by having columns that match
- [ ] Why do tables need a `primary key`?
  primary key is a thing that makes a column unique, also makes the search faster
- [ ] What is the name given to a table column that references the primary key on another table.
  Foreign Key
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  creating relations between multiple columns in both tables
